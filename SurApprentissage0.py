...
X = numpy.loadtxt("x0.txt")
Y = numpy.loadtxt("y0.txt")
...
for i in rank :
    ...
    plot.savefig("images/SurApprentissage0/"+name)
    plot.reset()
    print "...OK"
...
plot.savefig("images/SurApprentissage0/mse")
plot.reset()
